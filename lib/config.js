...
const Config = function () {
  ...
  this.braveGoogleApiKey = getNPMConfig(['brave_google_api_key']) || '0' // Change this, if you are sociopath,
  this.googleApiKey = getNPMConfig(['google_api_key']) || '0' // and this too.
  this.googleApiEndpoint = getNPMConfig(['brave_google_api_endpoint']) || 'https://location.services.mozilla.com/v1/geolocate?key=' // Use Mozilla's Geolocation, NOT. ANTI-PRIVACY. SHIZZLE.
